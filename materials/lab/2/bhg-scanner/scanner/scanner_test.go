...
func TestOpenPort(t *testing.T) {
	...
	get, _ := PortScanner("scanme.nmap.org:") // Currently function returns only number of open ports
...
func TestTotalPortsScanned(t *testing.T) {
	...
	get, got := PortScanner("scanme.nmap.org:") // Currently function returns only number of open ports
